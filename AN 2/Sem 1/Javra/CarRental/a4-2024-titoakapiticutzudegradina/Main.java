    ...
    public static void main(String[] args){
        ...
        try{
            ...
            if(RepositoryType.equals("DataBase")){
                //DataBaseRepository<Integer, Rental> rentalRepository = new DataBaseRepository();
                //rentalRepo = new DataBaseRentalRepositoryNew(rentalFilename);
                //carRepo = new DataBaseCarRepositoryNew(carFilename);
