...
public class TestRental {
    ...
    public void beforeTests_SetUp(){
        ...
        Car car2 = new Car(2,"BMW", "M3", 2015, 350);
        Car car3 = new Car(3,"Mercedes", "AMG", 2017, 400);
    ...
    public void test_getCar_returnTrue(){
        assert(rental1.getCar().equals(new Car(1,"Audi", "RS5", 2013, 300)));
        assert(rental2.getCar().equals(new Car(2,"BMW", "M3", 2015, 350)));
        assert(rental3.getCar().equals(new Car(3,"Mercedes", "AMG", 2017, 400)));
    }

    @Test
    public void test_setCar_returnTrue(){
        Car car = new Car(4,"Volkswagen", "Golf", 2019, 50);
        rental2.setCar(car);
