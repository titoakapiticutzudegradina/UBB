...
public class UI {
    ...
    public static final int FIND_RENTAL_BY_ID = 5;
    public static final int FILTER_BY_NAME = 6;
    public static final int FILTER_BY_CAR = 7;
    ...
    public void showMenu(){
        ...
        System.out.println("5.Find rental by id");
        System.out.println("6.Filter by name");
        System.out.println("7.Filter by car");
    }
